...
const TemplateOne = () => {
  return (
    <div className="user-funeral-template">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <div className="flowerimage">
            <img className="w-full" src="/img/flower-wr-removebg-preview.png" />
            <div className="personalinfo">
              <h1 className="username-temp">John Doe</h1>
            </div>
          </div>
          <div className="obituary-text">
            <h1 className="obituary-desc">Obituary</h1>
            <p className="fordescob">
              ...
              suddenly last Monday, leaving the New York art collective without
              one of its greatest references and catalysts.
            </p>
          </div>

          <div className="text-center mt-[38px]">
            <h1 className="obituary-desc pallbearer">Order of servicehandleContentChange</h1>
            <div className="grid grid-cols-2 ">
              <div className="border-r border-[#ad3262]">
        ...
        <div>
          <div className="flowerimage">
            ...
            <div className="funeral-images">
              <img src="/img/us-funeral-removebg-preview.png" />
            </div>
          </div>

          <div className="text-center">
            <h1 className="obituary-desc pallbearer">Pallbearer</h1>
            <div className="grid grid-cols-2 ">
              <div className="border-r border-[#ad3262]">
