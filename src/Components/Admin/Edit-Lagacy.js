...
import {
  LegacyAddAction,
  LegacyDetailsGetByIdAction,
  LegacyListShowAction,
  LegacyListUpdateAction,
...
const Edit_Lagacy = () => {
  ...
  const { loading: LagacyAddLoading } = useSelector(
  ...
  useEffect(() => {
    if (legacyID) {
      dispatch(LegacyDetailsGetByIdAction(legacyID));
    }
  }, [legacyID]);

  const { LegacyDetailsGetByID } = useSelector(
    (state) => state.LegacyDetailsGetByIDReducer
  );

  useEffect(() => {
    dispatch(LegacyListShowAction());
  }, []);

  const { success, error, message } = useSelector(
    (state) => state.LegacyListUpdateReducer
  );
  ...
  const [self_proven, setself_proven] = useState(false);
  const [distribution_sheet, setdistribution_sheet] = useState("");
  const [lagacywillID, setLagacywillID] = useState("");

  useEffect(() => {
    if (LegacyDetailsGetByID) {
      setdistribution_sheet(LegacyDetailsGetByID?.distribution_sheet);
      // legacy will
      setdescription(LegacyDetailsGetByID?.legacy_will?.description);
      sethint_video(LegacyDetailsGetByID?.legacy_will?.hint_video);
      setself_proven(LegacyDetailsGetByID?.legacy_will?.self_proven);
      setdocument(LegacyDetailsGetByID?.legacy_will?.document);
      setLagacywillID(LegacyDetailsGetByID?.legacy_will?.id);

      // legacy_retirement
      setlegacy_retirementdescription(
        LegacyDetailsGetByID?.legacy_retirement?.description
      );
      setlegacy_retirementID(LegacyDetailsGetByID?.legacy_retirement?.id);
      setlegacy_retirementhint_video(
        LegacyDetailsGetByID?.legacy_retirement?.hint_video
      );
      setlegacy_retirementdocument(
        LegacyDetailsGetByID?.legacy_retirement?.document
      );
      /* Legacy Funeral */
      setFuneraldescription(LegacyDetailsGetByID?.legacy_funeral?.description);
      setFuneralhint_video(LegacyDetailsGetByID?.legacy_funeral?.hint_video);
      setFuneraldocument(LegacyDetailsGetByID?.legacy_funeral?.document);
      setFuneralpackage_location(
        LegacyDetailsGetByID?.legacy_funeral?.package_location
      );
      setFuneralId(LegacyDetailsGetByID?.legacy_funeral?.id);
      setFuneralwish(LegacyDetailsGetByID?.legacy_funeral?.wish);
      setFuneraltype(LegacyDetailsGetByID?.legacy_funeral?.type);
    }

    /* Legacy Dept */

    if (LegacyDetailsGetByID?.legacy_debt?.length > 0) {
      setlegacy_debt(LegacyDetailsGetByID?.legacy_debt);
    }
    if (LegacyDetailsGetByID?.legacy_divorce?.length > 0) {
      setlegacy_divorce(LegacyDetailsGetByID?.legacy_divorce);
    }
    if (LegacyDetailsGetByID?.legacy_pension?.length > 0) {
      setlegacy_pension(LegacyDetailsGetByID?.legacy_pension);
    }
    if (LegacyDetailsGetByID?.legacy_accounts?.length > 0) {
      setlegacy_accounts(LegacyDetailsGetByID?.legacy_accounts);
    }
    if (LegacyDetailsGetByID?.legacy_insurance?.length > 0) {
      setlegacy_insurance(LegacyDetailsGetByID?.legacy_insurance);
    }

    if (LegacyDetailsGetByID?.legacy_property?.length > 0) {
      setLegacyProperty(LegacyDetailsGetByID?.legacy_property);
    }

    if (LegacyDetailsGetByID?.legacy_investment?.length > 0) {
      setlegacy_investment(LegacyDetailsGetByID?.legacy_investment);
    }

    if (LegacyDetailsGetByID?.legacy_vehicle?.length > 0) {
      setlegacy_vehicle(LegacyDetailsGetByID?.legacy_vehicle);
    }
  }, [LegacyDetailsGetByID]);
  ...
  const [legacy_retirementID, setlegacy_retirementID] = useState("");
  ...
  const FuneralhandleDocumet = (file) => {
    setFuneraldocument(file?.name);
  };

  const handleDistribution = (file) => {
    setdistribution_sheet(file?.name);
  };
  ...
  const handleSubmit = () => {
    ...
    // legacy will
    formData.append("legacy_will.self_proven", self_proven ? "True" : "False");
    if (hint_video) {
    ...
    if (lagacywillID) {
      formData.append("legacy_will.id", lagacywillID);
    }
    ...
    legacy_insurance.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_insurance[${index}].id`, item.id);
      }
    });
    ...
    if (FuneralId) {
      formData.append("legacy_funeral.id", FuneralId);
    }
    ...
    legacy_pension.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_pension[${index}].id`, item.id);
      }
      // Add other properties as needed and check for their values before appending
      if (item.document) {
    ...
    legacy_debt.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_debt[${index}].id`, item.id);
      }
    });
    ...
    legacy_divorce.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_divorce[${index}].id`, item.id);
      }
    });
    ...
    if (legacy_retirementID) {
      formData.append("legacy_retirement.id", legacy_retirementID);
    }
    ...
    LegacyProperty.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_property[${index}].id`, item.id);
      }
    });
    ...
    legacy_vehicle.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_vehicle[${index}].id`, item.id);
      }
    });
    ...
    legacy_investment.forEach((item, index) => {
      ...
      if (item.id) {
        formData.append(`legacy_investment[${index}].id`, item.id);
      }
    });

    dispatch(LegacyListUpdateAction(legacyID, formData));
    setRerender(true);
  };
  ...
  const [legacy_insurance, setlegacy_insurance] = useState([
    { id: null, description: "", company: "", document: "", hint_video: "" },
  ]);
  ...
  const [legacy_accounts, setlegacy_accounts] = useState([
    { id: "", description: "", name: "", document: null, hint_video: "" },
  ]);
  ...
  const handleAddClickAcc = () => {
    setlegacy_accounts([
      ...legacy_accounts,
      { id: null, description: "", name: "", document: null, hint_video: "" },
    ]);
  };
      ...
      <>
        <div className="">
          <div className="main-page-div bg-green-200">
            <h1 className="heading-top">Edit Legacy</h1>
            <div className="common-divbg bg-white">
              <div className="events-div my-12 ">
                ...
                <div className="mb-12">
                  <Collapse>
                    <Panel header="Legacy will" defaultActiveKey={["1"]}>
                      <>
                        {/* legacy will */}
                        <div className="legacy">
                          ...
                          <div className="flex items-center gap-4">
                            <label className="heading-title">Self Proven</label>
                            <input
                              checked={self_proven}
                              onChange={(e) => {
                          ...
                          <div className="">
                            <label className="heading-title">Document</label>
                            <FileUploader
                              handleChange={(e) => {
                                handleDocumet(e);
                              }}
                          ...
                          <div className="">
                            <label className="heading-title">Hint Video</label>
                            {/* <FileUploader
                              handleChange={(e) => {
                                handleVedio(e);
                              }}
                              ...
                              <div className="box">
                                ...
                                <div className="">
                                  ...
                                  <FileUploader
                                    ...
                                    types={fileTypes}
                                    handleChange={(file) =>
                                      handleFileUpload(file, "document", i)
                                ...
                                <div className="">
                                  ...
                                  </label>
                                  {
                                    ...
                                    types={fileTypes}
                                    handleChange={(file) =>
                                      handleFileUpload(file, "hint_video", i)
                        ...
                        <div className="legacy">
                          ...
                          <div className="input-boxdiv mb-4">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                setFuneralpackage_location(e.target.value);
                              }}
                            />
                          </div>
                              ...
                              <div className="box">
                                ...
                                <div className="btn-box">
                                  ...
                                  {legacy_accounts.length !== 1 && (
                                    <button
                                      className="remove-legacybtn"
                                      onClick={() => handleRemoveClickAcc(i)}
                                    >
                                      Remove
                                    </button>
                                  )}
                              ...
                              <div className="box">
                                ...
                                <div className="btn-box">
                                  {legacy_pension.length - 1 === i && (
                                    <button
                                      className="add-legacybtn"
                                      onClick={handleAddClicklegacy_pension}
                                    >
                                      Add
                                    </button>
                                  )}
                              ...
                              <div className="box">
                                    ...
                                    <div>
                                      ...
                                      >
                                        <DesktopDatePicker
                                          ...
                                          name="divorce_date"
                                          minDate={new Date()}
                                          value={new Date(item.divorce_date)}
                                          onChange={(newDate) => {
                                            const list = [...legacy_divorce];
                                            list[i].divorce_date = newDate;
                                            setlegacy_divorce(list);
                                          }}
                                          disablePast
                                          renderInput={(params) => (
                                ...
                                <div className="btn-box">
                                  {legacy_divorce.length - 1 === i && (
                                    <button
                                      className="add-legacybtn"
                                      onClick={handleAddClicklegacy_divorce}
                                    >
                                      Add
                                    </button>
                                  )}
                        ...
                        <div className="legacy">
                          ...
                          <div className="">
                            ...
                            <textarea
                              ...
                              onChange={(e) => {
                                setlegacy_retirementdescription(e.target.value);
                              }}
                              placeholder="Add Description"
                              className="w-full px-4 py-3 rounded-lg mt-2 border focus:outline-none"
                            ></textarea>
                          ...
                          <div className="">
                            ...
                            <input
                              ...
                              name="hint_video"
                              onChange={(e) =>
                                setlegacy_retirementhint_video(e.target.value)
                              }
                            />
                          </div>
                        </div>
                              ...
                              <div className="box">
                                ...
                                <div className="btn-box">
                                  {LegacyProperty.length - 1 === i && (
                                    <button
                                      className="add-legacybtn"
                                      onClick={handleAddClickLegacyProperty}
                                    >
                                      Add
                                    </button>
                                  )}
                              ...
                              <div className="box">
                                ...
                                <div className="btn-box">
                                  {legacy_vehicle.length - 1 === i && (
                                    <button
                                      className="add-legacybtn"
                                      onClick={handleAddClicklegacy_vehicle}
                                    >
                                      Add
                                    </button>
                                  )}
                              ...
                              <div className="box">
                                    ...
                                    <div>
                                      ...
                                      >
                                        <DesktopDatePicker
                                          ...
                                          name="date_invested"
                                          minDate={new Date()}
                                          value={new Date(item.date_invested)}
                                          onChange={(newDate) => {
                                            const list = [...legacy_investment];
                                            list[i].date_invested = newDate;
                                            setlegacy_investment(list);
                                          }}
                                          disablePast
                                          renderInput={(params) => (
                                ...
                                <div className="btn-box">
                                  {legacy_investment.length - 1 === i && (
                                    <button
                                      className="add-legacybtn"
                                      onClick={handleAddClicklegacy_investment}
                                    >
                                      Add
                                    </button>
                                  )}
                                  {legacy_investment.length !== 1 && (
                                    <button
                                      className="remove-legacybtn"
                                      onClick={() =>
                                        handleRemoveClicklegacy_investment(i)
                                      }
                                    >
                                      Remove
                                    </button>
